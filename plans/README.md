...
| 044 | Dashboard by role: headline tiles by capability (active employees, away today, applicants in progress, requests to decide, last payroll), applicant pipeline + open positions + recent applicants for jobs.view, celebrate block for everyone (kudos wall, birthdays day/month only, work anniversaries, new teammates, fun corner), Away today; Hiring tabs Job openings and Applicants across jobs (migration 0035) | DONE (main; smoke; unit; E2E home-dashboard) |
