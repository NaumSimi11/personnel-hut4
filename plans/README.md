...
| 045 | Simple HR flows (programme): the prototype's employee form as one Add employee dialog + Edit details, checklists editable per company and worked as a checkbox list, starter kit + IT told automatically, policy library + welcome note, kudos values; delivered as 046–050 | PLANNED (plan written; awaiting order and decisions §4) |
